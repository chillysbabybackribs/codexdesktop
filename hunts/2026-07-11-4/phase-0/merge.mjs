...
const intersections = [
  {intersectionId:'ix-ai-agent-operations',clusterId:'ai-agent-operations',marketMotion:64,workReality:58,whiteSpace:25,structuralCatalyst:70,penalties:25,score:36.7,status:'NO-GO',reason:'Broad formation and commercial activity, but clone saturation, founder echo, weak concrete job joins, and platform dependency fail the gate.'},
  ...
  {intersectionId:'ix-website-commerce',clusterId:'website-commerce-operations',marketMotion:48,workReality:44,whiteSpace:35,structuralCatalyst:35,penalties:25,score:18.1,status:'NO-GO',reason:'High activity is fragmented across unrelated jobs and overlaps saturated incumbents and previously promoted commerce ideas.'}
];
