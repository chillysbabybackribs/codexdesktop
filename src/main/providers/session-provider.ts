...
export interface SessionProvider {
  ...
  listThreads(options?: { cursor?: string | null; cwd?: string | null }): Promise<ThreadListResponse>
  ...
  getPluginAppStatuses(appIds: string[], forceRefetch?: boolean): Promise<CodexPluginAppStatusResponse>
