...
const taskShapingGuidance = [
  ...
  '- When calling `app_screenshot` or `browser_screenshot` from `functions.exec`, its successful result is a standalone `data:image/...` URI. Pass that result directly to `image()` when a preview is needed.',
