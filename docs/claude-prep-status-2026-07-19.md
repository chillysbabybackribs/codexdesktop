...
| 4. ProviderAdapter boundary | Not started | CodexClient behind an adapter interface; `codex:*` → `session:*` channels (21 to rename); capability descriptor (init gating, steering, efforts vs thinking, MCP vs dynamic tools, resume semantics). |
